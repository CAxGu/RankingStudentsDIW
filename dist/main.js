    ...
    value: function getTemplateRanking() {
      ...
      if (this.students && this.students.length > 0) {
        ...
        this.gradedTasks.forEach(function (taskItem) {
          GRADED_TASKS += '<td class="table-title">' + taskItem.name + '</td>';
        });
...
var Person = function () {
  ...
  _createClass(Person, [{
    ...
    value: function getHTMLView() {
      ...
      var titleResTaskName= document.createElement('span');
      var titleResTaskPoints= document.createElement('span');
      var titleResTaskOps= document.createElement('span');
      titleResTaskName.className="titleResponsive";
      titleResTaskPoints.className="titleResponsive";
      titleResTaskOps.className="titleResponsive";
      titleResTaskName.innerHTML='Name :' + '&nbsp;&nbsp;&nbsp;&nbsp';
      titleResTaskPoints.innerHTML='Points :' + '&nbsp;&nbsp;&nbsp;&nbsp';
      titleResTaskOps.innerHTML='Ops :' + '&nbsp;&nbsp;&nbsp;&nbsp';

      var liEl = document.createElement('tr');
      var label = document.createElement('label');
      label.innerHTML=this.surname + ', ' + this.name;
      var esEL = (0, _utils.getElementTd)(label);
      esEL.className="table-td";
      ...
      addAttitudeTaskEl.className="content-button";
      ...
      this.gradedTasks.forEach(function (gTaskItem) {
        ...
        var titleResTask= document.createElement('span');
        titleResTask.className="titleResponsive";
        titleResTask.innerHTML='Task '+gTaskItem.task.name+':' + '&nbsp;&nbsp;&nbsp;&nbsp';

        inputEl.className += "formcontent-inputtable";
        inputEl.setAttribute('aria-label','gradeTaskPoints');
        inputEl.type = 'number';
        inputEl.min = 0;
        inputEl.max = 100;
        ...
        inputEl.parentNode.insertBefore(titleResTask,inputEl.parentNode.childNodes[0]);
        
      });

      liEl.children[0].insertBefore(titleResTaskName,liEl.children[0].childNodes[0]);
      liEl.children[1].insertBefore(titleResTaskPoints,liEl.children[1].childNodes[0]);
      liEl.children[2].insertBefore(titleResTaskOps,liEl.children[2].childNodes[0]);
